...
class TestSigning(unittest.TestCase):
    ...
    def getRevisionInfo(self, pageUrl: str) -> Tuple[List[str], RevisionInfo]:
        ...
        self.controller.site.loadrevisions(page, startid=revId, rvdir=True, total=100)
    ...
    def test_needsUserOnlySigning(self) -> None:
        ...
        self.checkNeedsUserOnlySigning(
            "https://de.wikipedia.org/w/index.php?title=Wikipedia:Bots/Antr%C3%A4ge_auf_Botflag&diff=prev&oldid=189592572&diffmode=source"
        )  # on opt-in page
        self.checkNeedsUserOnlySigning(
